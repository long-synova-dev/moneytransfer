...
namespace MoneyTransferApp.Web.Extensions
{
    ...
    {
        public static string ReplaceIfNotNull(this string str, string oldString, string newString, string checkString)
        {
        ...
        public static string ReplaceIfNotNull(this string str, string oldString, string newString, bool checkCondition)
        {
            if (checkCondition)
            {
                return str.Replace(oldString, newString);
